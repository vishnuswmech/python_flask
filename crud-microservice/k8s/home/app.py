...
def root():
    ...
    return render_template("index.html",create_service_url=create_service_url,delete_port=delete_port,update_con_name=update_con_name,update_port=update_port,read_con_name=read_con_name,read_port=read_port)
