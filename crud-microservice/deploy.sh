...
#create
docker run -dit --name ${create_con_name} -h ${create_con_name} -p ${create_port}:${create_port} -e create_port=${create_port} -e home_con_name=${home_con_name} -e custom_network_name=${custom_network_name} -e home_port=${home_port} -e read_con_name=${read_con_name} -e read_port=${read_port} -e redis_host=${redis_con_name}.${custom_network_name} --net ${custom_network_name} -v /home/vishnu/workspace/new-flask/python_flask/crud-microservice/create:/root/flask ${create_image} /bin/bash

#read
docker run -dit --name ${read_con_name} -h ${read_con_name} -p ${read_port}:${read_port} -e read_port=${read_port} --net ${custom_network_name} -e redis_host=${redis_con_name}.${custom_network_name} -e custom_network_name=${custom_network_name} -e home_con_name=${home_con_name} -e home_port=${home_port} -v /home/vishnu/workspace/new-flask/python_flask/crud-microservice/read:/root/flask ${read_image} /bin/bash
...
#update
docker run -dit --name ${update_con_name} -p ${update_port}:${update_port} -h ${update_con_name} -e update_port=${update_port} -e home_con_name=${home_con_name} -e custom_network_name=${custom_network_name} -e home_port=${home_port} -e read_con_name=${read_con_name} -e read_port=${read_port} -e redis_host=${redis_con_name}.${custom_network_name} --net ${custom_network_name} -v /home/vishnu/workspace/new-flask/python_flask/crud-microservice/update:/root/flask ${update_image} /bin/bash

#delete
docker run -dit --name ${delete_con_name} -h ${delete_con_name} -p ${delete_port}:${delete_port} -e delete_port=${delete_port} -e home_con_name=${home_con_name} -e custom_network_name=${custom_network_name} -e home_port=${home_port} -e read_con_name=${read_con_name} -e read_port=${read_port} -e redis_host=${redis_con_name}.${custom_network_name} --net ${custom_network_name} -v /home/vishnu/workspace/new-flask/python_flask/crud-microservice/delete:/root/flask ${delete_image} /bin/bash
